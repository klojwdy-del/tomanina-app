              ...
              {Object.keys(counters).map((key) => (
                <div key={key} style={styles.counterBox}>
                  ...
                  <div style={{ display: 'flex', justifyContent: 'space-around' }}>
                    <button style={{ background: 'none', border: 'none', color: colors.primary, cursor: 'pointer', fontWeight: '700', fontSize: '1.1rem', fontFamily: 'inherit' }} onClick={() => incrementCounter(key)}>+1</button>
                    <button style={{ background: 'none', border: 'none', color: '#d9534f', cursor: 'pointer', fontSize: '0.8rem', fontFamily: 'inherit' }} onClick={() => resetCounter(key)}>تصفير</button>
                  </div>
                </div>
              ))}
            </div>
